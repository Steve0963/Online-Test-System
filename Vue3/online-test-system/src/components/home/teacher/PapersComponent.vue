<template>
  ...
  /></div> -->
    ...
    <el-table ref="tableRef" row-key="id" :data="tableData" stripe>
      ...
      <el-table-column prop="date" label="考试时间" sortable  column-key="date" :filters="timeFilterOptions()" :filter-method="filterHandler" />
      <el-table-column prop="type" label="考试方式" sortable :filters="typeFilterOptions" :filter-method="filterHandler"/>
