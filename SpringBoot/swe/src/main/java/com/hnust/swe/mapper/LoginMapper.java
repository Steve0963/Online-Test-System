...
public interface LoginMapper {
    ...
    @Select("SELECT teacher_account.account,teacher_account.role, teacher_info.name from teacher_account INNER JOIN teacher_info ON teacher_account.account = teacher_info.account WHERE teacher_account.account = #{account} and teacher_account.password = #{password}")
